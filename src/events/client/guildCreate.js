    ...
    try {
        ...
        Promise.all(promises)
            .then(async (results) => {
                ...
                const embed = new Discord.EmbedBuilder()
                    ...
                    .setThumbnail("https://cdn.discordapp.com/avatars/941461627667120148/30a6e056be5d0aaf6a30c141384c4ca3.png?size=1024")
        ...
        client.embed({
            ...
            },
            {
                ...
                value: `You can DM <@640512148786642947> for support or joining the [[Support server]](${client.config.discord.serverInvite})`,
                inline: false,
            },
            {
